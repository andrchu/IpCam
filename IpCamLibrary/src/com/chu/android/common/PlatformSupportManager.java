...
package com.chu.android.common;
        ...
        for (Integer minVersion : implementations.keySet()) {
            if (Build.VERSION.SDK_INT >= minVersion) {
                ...
                try {
                    ...
                    com.chu.android.LogUtil.i(TAG, "Using implementation " + clazz + " of " + managedInterface + " for SDK " + minVersion);
                    return clazz.getConstructor().newInstance();
                } catch (ClassNotFoundException cnfe) {
                    com.chu.android.LogUtil.w(TAG, cnfe);
                } catch (IllegalAccessException iae) {
                    com.chu.android.LogUtil.w(TAG, iae);
                } catch (InstantiationException ie) {
                    com.chu.android.LogUtil.w(TAG, ie);
                } catch (NoSuchMethodException nsme) {
                    com.chu.android.LogUtil.w(TAG, nsme);
                } catch (InvocationTargetException ite) {
                    com.chu.android.LogUtil.w(TAG, ite);
                }
            }
        }
        com.chu.android.LogUtil.i(TAG, "Using default implementation " + defaultImplementation.getClass() + " of " + managedInterface);
