...
import com.handmark.pulltorefresh.library.internal.I_RefreshLinstener;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>, I_RefreshLinstener {
    ...
    private I_RefreshLinstener i_refreshLinstener;
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (i_refreshLinstener != null) {
            i_refreshLinstener.isPullDown(movevalue);
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        i_refreshLinstener = mHeaderLayout;
