...
public class Sip1120VideoActivity extends BaseSipDeviceActivity implements ReceiveSip1303FrameDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + mIp + ":" + mPort + "/cgi-bin/video_snapshot.cgi?user=" + mAccount + "&pwd=" + mPassword;
        ...
        imageView.setOnTouchListener(new OnSwipeTouchListener(this) {
            ...
            public void onSwipeSingleTapUp() {
                ...
                if (videoTopPopWindow == null) {
                    videoTopPopWindow = new VideoPopWindow(Sip1120VideoActivity.this, mTopIcons, Sip1120VideoActivity.this);
                }
        ...
        if (isTop) {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    Toast.makeText(Sip1120VideoActivity.this, getString(R.string.tips_snapshot_ok), Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    //分享
