...
public class Sip1303Monitor extends SurfaceView implements SurfaceHolder.Callback, ReceiveSip1303FrameDataListener {
    ...
    public Sip1303Monitor(Context context) {
        super(context);
        mSurHolder = getHolder();
        mSurHolder.addCallback(this);
    }

    public Sip1303Monitor(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSurHolder = getHolder();
        mSurHolder.addCallback(this);
    }
    ...
    public void attachCamera(VideoIOSocket videoIOSocket) {
    ...
    public void deattachCamera(VideoIOSocket videoIOSocket) {
