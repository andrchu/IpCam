 ...
 */
public class SeeSip1201DeviceActivity extends BaseSeeWorldActivity {

    private MjpegView monitor;
    private String URL;
    private int videoChannel = 12;//第二通道码流,对应分辨率为640*352
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentModelId = GetCameraModel.CAMERA_MODEL_SIP1201;
        setContentView(R.layout.activity_see_sip1201_device);
        ...
        sb.append(":");
        sb.append(port);
        sb.append("/cgi-bin/hi3510/mjpegstream.cgi?-chn=" + videoChannel + "&-usr=");
        sb.append(account);
        sb.append("&-pwd=");
        sb.append(password);
        URL = sb.toString();
        monitor = (MjpegView) findViewById(R.id.monitor);
        monitor.setOnTouchListener(SeeSip1201DeviceActivity.this);
    ...
    public class DoRead extends AsyncTask<String, Void, MjpegInputStream> {
        ...
        protected void onPostExecute(MjpegInputStream result) {
            if (result == null) {
                Toast.makeText(SeeSip1201DeviceActivity.this, getString(R.string.connstus_connection_failed), Toast.LENGTH_LONG).show();
//                SeeSip1201DeviceActivity.this.finish();
            } else {
                doSetLayoutOnOrientation(mVideoWidth, mVideoHeight);
                monitor.setVideoRadio((mVideoWidth * 1.0f) / mVideoHeight);
                record = new Record(SeeSip1201DeviceActivity.this, mVideoWidth, mVideoHeight, summary.deviceId);
