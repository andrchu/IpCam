...
public class Sip1406Monitor extends SurfaceView implements SurfaceHolder.Callback, ReceiveSip1303FrameDataListener {
    ...
    public Sip1406Monitor(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSurHolder = getHolder();
        mSurHolder.addCallback(this);
    }
    ...
    public void attachCamera(Sip1406Camera sip1406Camera) {

        if (sip1406Camera != null) {
            sip1406Camera.registerReceiveFrameDataListener(this);
        }
    ...
    public void deattachCamera(Sip1406Camera sip1406Camera) {

        if (sip1406Camera != null) {
            sip1406Camera.unRegisterReceiveFrameDataListener(this);
        }
