...
public class RegisterActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        registerByEmail = (TextView) findViewById(R.id.register_by_email);
        registerByEmail.setOnClickListener(this);
        registerByPhone = (TextView) findViewById(R.id.register_by_phone);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.get_code:
                ...
                doPost(UrlResources.URL_GET_REGISTER_SMS_CODE, ApiClientUtility.getParams(map), new VolleyResponse(this, false, getString(R.string.com_facebook_loading)) {
    ...
    private void check() {
        ...
        if (isRegisterByEmail) {
            ...
            map.put(CameraConstants.USER_ID, UserAccount.getUserID() + "");
            map.put(HttpRequestConstants.USER_NAME, accountStr);
            map.put(HttpRequestConstants.USER_PASSWORD, passwordStr);
            map.put(HttpRequestConstants.USER_CONFIRM_PASSWORD, passwordTwiceStr);
            doPost(UrlResources.URL_REGISTER_EMAIL, ApiClientUtility.getParams(map), new VolleyResponse(this, true, getString(R.string.com_facebook_loading)) {

                @Override
                public void onSuccess(JSONObject result) {
                    makeToast(getString(R.string.register_by_email_success) + accountStr + getString(R.string.register_enable_account));
            ...
            doPost(UrlResources.URL_REGISTER_PHONE, ApiClientUtility.getParams(map), new VolleyResponse(this, true, getString(R.string.com_facebook_loading)) {
